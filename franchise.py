...
def firm():
    #takes the firm level orders and gets the firm level orders 
    return
...
#    frame['time'] = pd.to_datetime(frame['time'], format).apply(lambda x: x.time())
    return err + m
...
#==============================================================================
    ...
    #Waiting, getting the canceled orders takes about 9 minutes to do 
    #leaps
